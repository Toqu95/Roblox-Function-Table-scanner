...
for i,v in pairs(getgc()) do
    if type(v) == "function" then
        if debug.getinfo(v).name == "IsRunning" then
            fHookTrue(v, true)
        end
        if debug.getinfo(v).name == "IsShaking" then
            fHookFalse(v, false)
        end
        if debug.getinfo(v).name == "DoRecoil" then
            fHookNil(v)
        end
        if debug.getinfo(v).name == "onJumping" then
            fHookNil(v)
        end
        if debug.getinfo(v).name == "UpdateShake" then
            fHookNil(v)
        end
        if debug.getinfo(v).name == "GetIsSliding" then
            fHookFalse(v, false)
        end
